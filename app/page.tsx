...
type CastMember = {
  ...
  standing: string;
  relation: string;
  portrait?: { src: string; position: string; detailPosition: string; zoom: string; scale?: string };
};
...
const cast: readonly CastMember[] = [
  { name: "이소현", role: "자발적 고립", tone: "white", line: "학업·품행·생활관리까지 완벽했던 엄친딸. 자신을 돕던 사람들이 보복으로 무너지는 것을 본 뒤 관계를 약점으로 판단해 스스로 외톨이가 되었다.", quote: "…신경 꺼. 너까지 망가지는 건 보기 싫어.", trait: "ISFJ · 6w5 · sp/sx", standing: "2학년 3반 · 피해 학생", relation: "도움을 밀어내면서도 곁을 바람", portrait: { src: "./characters/lee-sohyeon.webp?v=681496cbd1c1", position: "50% 0%", detailPosition: "50% 0%", zoom: "250%", scale: "0.8" } },
...
const portraitStyle = (person: CastMember): React.CSSProperties | undefined => person.portrait ? ({
  ...
  "--portrait-scale": person.portrait.scale ?? "1",
