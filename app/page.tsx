...
const cast: readonly CastMember[] = [
  { name: "이소현", role: "자발적 고립", tone: "white", line: "학업·품행·생활관리까지 완벽했던 엄친딸. 자신을 돕던 사람들이 보복으로 무너지는 것을 본 뒤 관계를 약점으로 판단해 스스로 외톨이가 되었다.", quote: "…신경 꺼. 너까지 망가지는 건 보기 싫어.", trait: "ISFJ · 6w5 · sp/sx", standing: "2학년 3반 · 피해 학생", relation: "도움을 밀어내면서도 곁을 바람", portrait: { src: "./characters/lee-sohyeon.webp", position: "59% 13%", detailPosition: "59% 6%", zoom: "250%" } },
  ...
  { name: "이도현", role: "학생회 권력", tone: "red", line: "경찰청장 아들이자 학생회장. 진희주와 결탁해 학생회 권한으로 학생들을 압박하며 소현을 자기 소유처럼 여기고 거절당할수록 통제를 강화한다.", quote: "학생회가 정한 질서에는 이유가 있어.", trait: "ESTJ · 3w2 · so/sp", standing: "학생회장 · 경찰청장 아들", relation: "체면과 소유욕에 기반한 집착", portrait: { src: "./characters/lee-dohyeon.png", position: "50% 14%", detailPosition: "50% 0%", zoom: "320%" } },
  { name: "안수진", role: "비극을 기다리는 관찰자", tone: "white", line: "일진과 어울리지 않는 대기업 회장 딸이자 최상위권 천재. 소현을 돕지 않고 구원자가 나타나는 비극을 구경하며, 자신을 논리로 꺾은 상대에게 복종하고 집착하길 갈망한다.", quote: "더 보여주시겠어요? 어디까지 옳을 수 있는지.", trait: "ENFJ · 2w1 · so/sx", standing: "대기업 회장 딸 · 최상위권", relation: "지적 호기심이 집착으로 변할 가능성", portrait: { src: "./characters/ahn-sujin.webp", position: "54% 31%", detailPosition: "54% 7%", zoom: "280%" } },
  ...
  { name: "진동욱", role: "지역 카르텔의 정점", tone: "red", line: "진희주의 친부인 현역 국회의원. 딸보다 자신의 정치 생명을 먼저 지키며 권력·인맥·돈을 도구로 삼고, 필요하면 가족과 측근도 버린다.", quote: "학생, 선을 넘으면 서로 피곤해집니다.", trait: "현역 국회의원 · 진희주 친부", standing: "권력과 은폐의 정점", relation: "회유 가능한 위험요소로 판단", portrait: { src: "./characters/jin-dongwook.webp", position: "50% 17%", detailPosition: "50% 18%", zoom: "310%" } },
];

const characterGallery: Record<string, string[]> = {
  "이소현": ["./characters/lee-sohyeon-scene-01.webp", "./characters/lee-sohyeon-scene-02.webp", "./characters/lee-sohyeon-scene-03.webp", "./characters/lee-sohyeon-scene-04.webp"],
...
const characterRelationships: CharacterRelationship[] = [
  ...
  { from: "진희주", to: "서은정", label: "권력과 지능의 공생", detail: "진희주는 빽과 서열을, 서은정은 궤변과 여론 조작을 제공하며 서로의 폭력을 효율적으로 만든다.", tone: "complicity", direction: "mutual", labelShiftX: 18, labelShiftY: -68 },
  ...
  { from: "진희주", to: "강태호", label: "명령 · 불쾌한 복종", detail: "진희주는 강태호의 무력을 자기 권력으로 취급하지만, 강태호는 가담 자체와 약자 괴롭힘을 혐오한다.", tone: "complicity", direction: "one-way", labelShiftX: 30, labelShiftY: -38 },
